...
var changeEvents = function (version) { var _a, _b, _c; return ((_c = (_b = (_a = TinyMCE_1.getTinymce(version)) === null || _a === void 0 ? void 0 : _a.Env) === null || _b === void 0 ? void 0 : _b.browser) === null || _c === void 0 ? void 0 : _c.isIE()) ? 'change keyup compositionend setcontent' : 'change input compositionend setcontent'; };
...
var Editor = /** @class */ (function (_super) {
    ...
    function Editor(props) {
        ...
        _this.initialise = function (attempts) {
            ...
            var tinymce = TinyMCE_1.getTinymce(_this.props.version);
            if (!tinymce) {
    ...
    Editor.prototype.componentDidMount = function () {
        ...
        if (TinyMCE_1.getTinymce(this.props.version) !== null) {
            this.initialise();
        }
    ...
    Editor.prototype.componentWillUnmount = function () {
        ...
        if (editor) {
            editor.off(changeEvents(this.props.version), this.handleEditorChange);
    ...
    Editor.prototype.bindHandlers = function (prevProps) {
        ...
        if (this.editor !== undefined) {
            ...
            if (!wasControlled && nowControlled) {
                this.editor.on(changeEvents(this.props.version), this.handleEditorChange);
                ...
                this.editor.off(changeEvents(this.props.version), this.handleEditorChange);
